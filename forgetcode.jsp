...
<html>
    ...
    <body>
        <%
            ...
            String sql = "select * from usermaster where email='" + to + "'";
            ResultSet rs = st.executeQuery(sql);
            String original_password = null;
            if (rs.next()) {
                original_password = rs.getString("password");
                //out.println(original_password);

            }
            final String message = "your original password :: " + original_password;
            ...
            try {
                ...
                msg.setSubject("Forget Password-DMS");
